...
class FeatureExtraction:
    ...
    def get_features(self):
        ...
        self.train_features = hstack(
            [train_sentences_c, train_sentences_w, spans[: self.train_data.size]]
        )
        self.dev_features = hstack(
            [dev_sentences_c, dev_sentences_w, spans[self.train_data.size :]]
        )
